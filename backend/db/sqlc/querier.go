...
type Querier interface {
	...
	GetActiveBugsByAssignedProfile(ctx context.Context, profile uuid.UUID) ([]Bug, error)
	...
	GetBugsByAssigneeProfile(ctx context.Context, profile uuid.UUID) ([]Bug, error)
